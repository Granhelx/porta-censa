...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        <div className='max-w-[1300px] mx-auto  flex justify-between text-green-500
        text-xl items-center px-12 h-20'>

            <a href="#">Granhelx</a>

            <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                <li><Link to="skills" smooth={true} offset={50} duration={500}>Acerca de mi</Link></li>
            ...
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    <li><Link to="skills" onClick={closeNav} smooth={true} offset={50} duration={500}>Acerca de mi</Link></li>
